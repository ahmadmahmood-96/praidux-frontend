    ...
    <div className="pt-[35px] px-[100px] pb-[16.8px] flex flex-col gap-[16px] items-center max-[1150px]:px-[50px] max-[768px]:px-[24px]">
      ...
      <div className="flex flex-col gap-[18px] items-center">
        ...
        <div className="flex gap-[24px] w-full justify-center items-center">
          <button className="bg-[#FF5F1F] rounded-[40px] px-[21px] py-[12px] border-none font-poppins font-medium  text-[16px] leading-[100%] text-[#FFFFFF] max-[525px]:text-[14px] max-[525px]:px-[15px] max-[525px]:py-[10px] max-[420px]:text-[12px]">
            Contact Us
          </button>
